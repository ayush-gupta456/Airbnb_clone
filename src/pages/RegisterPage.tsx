            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className={`input ${passwordError && password ? 'border-red-300 focus:ring-red-500' : ''}`}
                />
              </div>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className={`input ${passwordError && confirmPassword ? 'border-red-300 focus:ring-red-500' : ''}`}
                />
              </div>
              {passwordError && (
